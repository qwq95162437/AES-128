...
REM
REM Generated by Vivado on Sun May 17 12:24:07 +0800 2026
...
echo "xvlog --incr --relax -prj aes_fault_tb_vlog.prj"
call xvlog  --incr --relax -prj aes_fault_tb_vlog.prj -log xvlog.log
